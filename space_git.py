...
def generate_video_with_music(part1: str, part2: str, output_filename: str):
    ...
    heading_clip = TextClip(heading_text, fontsize=75, color='black', font="Arial-Rounded-MT-Bold", size=heading_bg.size).set_position(final_position).set_duration(VIDEO_DURATION)
    ...
    quote_clip1 = TextClip(part1, fontsize=80, color='white', font="Arial-Rounded-MT-Bold", stroke_color='black', stroke_width=3,
    ...
    quote_clip2 = TextClip(part2, fontsize=80, color='white', font="Arial-Rounded-MT-Bold", stroke_color='black', stroke_width=3,
                           size=(1080 * 0.9, None), method='caption')
